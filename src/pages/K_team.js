                ...
                <Slider {...settings}>
                  ...
                  <div className="team-box">
                    <a href="#">
                      ...
                      <div className="team-image">
                        <img
                          src="../assets/images/blog/Kundali1.jpg"
                          className="img-fluid blur-up lazyload"
                          alt=""
                        />
                      </div>
                  ...
                  <div className="team-box">
                    <a href="#">
                      ...
                      <div className="team-image">
                        <img
                          src="../assets/images/blog/Kundali2.jpg"
                          className="img-fluid blur-up lazyload"
                          alt=""
                        />
                      </div>
                  ...
                  <div className="team-box">
                    <a href="#">
                      ...
                      <div className="team-image">
                        <img
                          src="../assets/images/blog/Kundali3.jpg"
                          className="img-fluid blur-up lazyload"
                          alt=""
                        />
                      </div>
                  ...
                  <div className="team-box">
                    <a href="#">
                      ...
                      <div className="team-image">
                        <img
                          src="../assets/images/blog/Kundali4.jpg"
                          className="img-fluid blur-up lazyload"
                          alt=""
                        />
                      </div>
                  ...
                  <div className="team-box">
                    <a href="#">
                      <div className="team-image">
                        <img
                          src="../assets/images/astro/match.jpg"
                          className="img-fluid blur-up lazyload"
                          alt=""
                        />
                      </div>
